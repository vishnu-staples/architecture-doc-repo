...
This repository follows defined review and documentation standards to maintain a single source of truth and prevent drift.
...
- [`Decision records (ADR index)`](decision-records/index.md)
